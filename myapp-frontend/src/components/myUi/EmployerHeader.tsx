...
export const EmployerHeader: React.FC<EmployerHeaderProps> = ({ employerData, setStoreModal, setUserMenuOpen }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <motion.button
          className="rounded-full text-white shadow-lg p-3 bg-gradient-to-tr from-green-500 via-green-600 to-emerald-500"
